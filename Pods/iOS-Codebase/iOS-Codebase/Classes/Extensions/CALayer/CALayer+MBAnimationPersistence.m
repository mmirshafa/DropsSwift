...
- (void)MB_persistLayerAnimationsAndPause;
- (void)MB_restoreLayerAnimationsAndResume;
...
//    [self ___display];
//    
//    MBPersistentAnimationContainer* animContainer = [self MB_animationContainer];
//    if (animContainer)
//    {
//        NSLog(@"will rresume!??");
//        [animContainer MB_restoreLayerAnimationsAndResume];
//    }
//}
//
//+(void)load
...
//        [CALayer swizzleMethod:@selector(display) withMethod:@selector(___display)];
//    });
//}
...
//	NSLog(@"TIMSINCE PAUSE: %f", timeSincePause);
...
- (void)applicationDidEnterBackground {
	[self MB_persistLayerAnimationsAndPause];
}

- (void)applicationWillEnterForeground {
	[self MB_restoreLayerAnimationsAndResume];
}
