...
-(void)initialize
{
	...
	//	_shadowViewHolder.backgroundColor = [UIColor yellowColor];
...
-(void)setPrimaryColor:(UIColor *)primaryColor
{
	...
	_innerContent.backgroundColor = primaryColor;
}
