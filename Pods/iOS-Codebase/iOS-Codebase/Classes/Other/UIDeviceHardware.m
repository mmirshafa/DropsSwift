...
+(BOOL)isIphoneX
{
    ...
    NSString* pltfrm = [NSString stringWithFormat:@"%s" , getenv("SIMULATOR_MODEL_IDENTIFIER")];
#else
    NSString* pltfrm = [self platform];
#endif
    
    return [pltfrm isEqualToString:@"iPhone10,6"] || [pltfrm isEqualToString:@"iPhone10,3"] || [pltfrm isEqualToString:@"iPhone11,2"] || [pltfrm isEqualToString:@"iPhone11,4"] || [pltfrm isEqualToString:@"iPhone11,6"] || [pltfrm isEqualToString:@"iPhone11,8"];
}
